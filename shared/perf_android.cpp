...
extern "C" float perfGetCpuUsage(void) {
  ...
  // First call just return 0 abd remembers values fro next call
  if (lastProcTicks == 0) {
  ...
  //Calcluate percentage of CPU usage since last call
